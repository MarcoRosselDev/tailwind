...
let codingFact =
  "I like to code with " + favoriteLanguage + " because it's interesting.";
console.log(codingFact);
codingFact =
  "I like to code with " + favoriteLanguage + " because it's really fast.";
console.log(codingFact);
codingFact =
  "I like to code with " + favoriteLanguage + " because it's clean and cool.";
console.log(codingFact);
